...
public class WristThenArmSequenceCommandTest extends SequentialCommandGroup {
  ...
  public WristThenArmSequenceCommandTest(Arm arm_sub, Wrist wrist, Arm.SuperStructurePosition position_req) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      arm_sub.set_state(ArmState.Moving),
      new WristDriveToPositionPIDTest(arm_sub, wrist, position_req),
